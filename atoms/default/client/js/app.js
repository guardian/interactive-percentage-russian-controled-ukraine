...
// import ukraineControl from 'assets/ukraine-control/merged-topo.json'
// import russiaControl from 'assets/russian-control/merged-topo.json'
// import russiaAdvance from 'assets/russian-advance/merged-topo.json'
...
// }
// const dates = sheet.sheets.scrolly.map(d => d.Date).filter(f => f != '').filter(onlyUnique);

// console.log(ukraineControl)
...
// 			overall: () => {}
// 		})
// 		Object.keys(ukraineControl.objects).forEach(key => {
// 			console.log(ukraineControl.objects[key].geometries)
// 		})
// 	scrolly.gradual( (progressInBox, i, abs, total) => {

// 		console.log('**********',i, sheet.sheets.scrolly.length-1)

// 		if(i < sheet.sheets.scrolly.length-1)
// 		{

// 			let iniDate = sheet.sheets.scrolly[i].Date;
// 			let endDate = sheet.sheets.scrolly[i+1].Date;
